...
screen_setScreenViewTop
                              ...
                              lea.l      screen_buffer_StartYOffset,a0
                              move.l     (a0),d1
                              ;add.l     #32*screenBuffer_lineSize,d1
                              cmp.w      #(screenBuffer_height*screenBuffer_lineSize)-screenBuffer_lineSize,d1
                              ble        screen_sSVT
                              ;sub.w     #(screenBuffer_height*screenBuffer_lineSize),d1
screen_sSVT:
...
;screen_calcScrollWaitBottom
                              lea.l      copperSlot,a1
                              lea.l      screenBottomWait,a4
                              move.w     (a4),d6
                              cmp.w      #44,d6                                                                     ; d6>=44
                              blt        s_aSB2CLi_done                                                             ;nothing to do here
 ;screen_calcScrollWaitBottom end 
...
s_aSB2CLi_wait:  
                              ...
                              lea.l      virtualscreen_xPosition,a3
