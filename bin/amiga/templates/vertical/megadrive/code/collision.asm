...
c_bullet_ex_sipP:
  ...
  ; create explosion
             ...
             move.w     player_pos_y,d1                                        ; player y pos
...
collTilesHit:
             move.w     old_player_pos_x,player_pos_x                           ; rollback
             move.w     old_player_pos_y,player_pos_y
             bsr        checkTrigger					   
             rts
...
collision_checkTilesByDir:
  ...
  ;moveq     #0,d1
             move.l     player_current,a2                               ; get player
             add.w      player_pos_x,d0                                         ; srcx
             add.w      virtualscreen_xPosition,d0
             add.w      player_pos_y,d1                                        ; srcy  
  ;add.w     virtualscreen_yPosition,d1          ; add current virtualscreen_yPosition
