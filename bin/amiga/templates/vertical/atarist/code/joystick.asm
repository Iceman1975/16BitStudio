joystick_init:	;Install Joystick handler
...
; if fire button pressed, add 1 to colour 0
                move.b  Joystickdata+1,d0          ; check joystick 1
				move.l  #0,joystick1_button ; clear button flags
				move.l  #0,joystick1_left   ; clear direction flags 
                cmp     #128,d0                  ; fire
                blt     no_fire
