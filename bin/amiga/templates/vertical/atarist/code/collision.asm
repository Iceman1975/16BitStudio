...
.c_ene_check:
             move.l    14(a0),a4                           ; get enemy pointer
             move.w    2(a0),d2                            ; dstx  ene
             add.w     40(a4),d2
             move.w    4(a0),d3                            ; dsty  ene
             add.w     42(a4),d3
